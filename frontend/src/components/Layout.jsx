...
import { isCitizen, isStaff } from '../lib/roles.js';
    ...
    <div className="app-shell">
      <header className="topbar">
        ...
        <nav className="nav">
          ...
          {isCitizen(user) && <NavLink to="/reports/new" className={navClass}>Report</NavLink>}
          {isCitizen(user) && <NavLink to="/dashboard" className={navClass}>Dashboard</NavLink>}
